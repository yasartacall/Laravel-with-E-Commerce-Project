                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            @foreach ( $datalist as $rs)
                                <tr>
                                    ...
                                    <td>{{ $rs->phone}}</td>
                                    <td>{{ $rs->address}}</td>
                                    <td> @foreach($rs->roles as $row) <!-- ilişkiden kaynaklı, rollerin içinde birden fazla eleman var-->
                                        {{ $row->name }}, <!-- rol isimleri yazılıp yanına virgül eklenicek hangi rol varsa-->
                                        @endforeach
